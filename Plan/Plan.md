...
3. ✅ **Mode globe** : rendre la barre des constellations dépliable : petite flèche si on clique se replie, on reclique se redéplie.
4. ✅ En **mode globe**, ajouter un fond d'étoiles pour la déco, non interactif et léger. Pas à partir d'une image, juste un fond de points légers qui donnent une impression d'espace (peut-être avec un petit mouvement des étoiles pour faire comme si ça bougeait).
5. ✅ Ajouter en **mode globe** une représentation de l'ISS + sa trajectoire en temps réél.
6. ✅ En **mode sky**, trouver une couleur pour la terre.
7. ✅ En **mode sky**, ajouter un indicateur vers la terre lorsqu'elle n'est plus dans l'angle de la caméra, comme pour les constellations.
